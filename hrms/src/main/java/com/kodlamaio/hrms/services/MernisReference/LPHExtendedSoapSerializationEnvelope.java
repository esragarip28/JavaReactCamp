...
public class LPHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LPHDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LPHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LPHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LPHDateTimeConverter dateTimeConverter = new LPHStandardDateTimeConverter();

    public LPHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LPHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LPHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LPHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LPHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LPHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
