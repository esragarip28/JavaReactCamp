...
public class JTMKPSPublicSoap
{
    ...
    public JTMKPSPublicSoap(){}

    public JTMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public JTMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        JTMExtendedSoapSerializationEnvelope envelope= new JTMExtendedSoapSerializationEnvelope(JTMExtendedSoapSerializationEnvelope.VER11);
