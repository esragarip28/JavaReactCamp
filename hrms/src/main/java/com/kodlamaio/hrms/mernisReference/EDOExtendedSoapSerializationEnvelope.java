...
public class EDOExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EDODateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EDOStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EDODateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EDODateTimeConverter dateTimeConverter = new EDOStandardDateTimeConverter();

    public EDOExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EDOExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EDOMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EDOHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EDOExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EDOHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
