...
public class JTMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(JTMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new JTMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static JTMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static JTMDateTimeConverter dateTimeConverter = new JTMStandardDateTimeConverter();

    public JTMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public JTMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new JTMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=JTMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,JTMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=JTMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
