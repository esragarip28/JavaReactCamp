...
public class WPBExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(WPBDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new WPBStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static WPBDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static WPBDateTimeConverter dateTimeConverter = new WPBStandardDateTimeConverter();

    public WPBExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public WPBExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new WPBMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=WPBHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,WPBExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=WPBHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
