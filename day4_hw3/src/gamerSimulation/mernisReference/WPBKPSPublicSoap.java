...
public class WPBKPSPublicSoap
{
    ...
    public WPBKPSPublicSoap(){}

    public WPBKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public WPBKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        WPBExtendedSoapSerializationEnvelope envelope= new WPBExtendedSoapSerializationEnvelope(WPBExtendedSoapSerializationEnvelope.VER11);
