...
public class VHSKPSPublicSoap
{
    ...
    public VHSKPSPublicSoap(){}

    public VHSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VHSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VHSExtendedSoapSerializationEnvelope envelope= new VHSExtendedSoapSerializationEnvelope(VHSExtendedSoapSerializationEnvelope.VER11);
