...
public class VHSExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VHSDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VHSStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VHSDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VHSDateTimeConverter dateTimeConverter = new VHSStandardDateTimeConverter();

    public VHSExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VHSExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VHSMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VHSHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VHSExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VHSHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
